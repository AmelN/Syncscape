...
//}
//ubo int UserUniforms 0:37:4736 {
...
float3 param_4=Output_N5.xyz;
float param_5=Output_N7;
...
float4 l9_15=fast::max(param_13,float4(0.0));
float4 param_14=l9_15;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_82=param_17;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_82.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_82;
return out;
}
} // FRAGMENT SHADER
...
Output_N7=Output_N5.w;
float Output_N0=0.0;
float param_1=(*sc_set0.UserUniforms).roughness;
Output_N0=param_1;
float param_2=Output_N7;
