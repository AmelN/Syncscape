...
exports.PlayerColorAssigner = void 0;
/**
...
class PlayerColorAssigner {
     ...
     */
    static getColorIndexForPlayer(connectionId, totalColors) {
        if (totalColors <= 0) {
     ...
     */
    static getColorName(colorIndex) {
        const colorNames = [
     ...
     */
    static validateColorCount(availableColors) {
     ...
     */
    static getSessionColorAssignments(userInfoList, totalColors) {
...
exports.PlayerColorAssigner = PlayerColorAssigner;
//# sourceMappingURL=PlayerColorAssigner.js.map