...
//float Port_Import_N038 7392
//float Port_Import_N041 7396
//float3 Port_Import_N047 7408
//float3 Port_Import_N050 7424
//float3 Port_Import_N056 7440
//float3 Port_Import_N067 7456
//float3 Port_Import_N005 7472
//float3 Port_Import_N007 7488
//float3 Port_Import_N072 7504
//float3 Port_Import_N074 7520
//float Port_Input2_N075 7536
//float3 Port_Import_N076 7552
//float Port_Multiplier_N077 7568
//float2 Port_Input1_N081 7576
//float2 Port_Scale_N082 7584
//float2 Port_Input1_N084 7592
//float2 Port_Scale_N086 7600
//float2 Port_Input1_N088 7608
//float2 Port_Scale_N089 7616
//float3 Port_Input1_N091 7632
//float Port_Import_N020 7648
...
//float Port_Import_N098 7680
//float Port_Import_N099 7684
//float Port_Min_N115 7688
//float Port_Max_N115 7692
//float Port_Import_N110 7712
//}
...
float Port_Min_N115;
float Port_Max_N115;
float3 Port_Import_N108;
float Port_Import_N110;
};
struct sc_Set0
{
...
l9_46=!(UserUniforms.vfxBatchEnable[l9_47/20000]!=0);
}
else
{
l9_46=l9_45;
...
float l9_22=0.0;
l9_22=(*sc_set0.UserUniforms).Port_Import_N041;
float l9_23=0.0;
float l9_24=l9_21;
float l9_25=l9_22;
...
l9_104=(*sc_set0.UserUniforms).Port_Import_N047;
...
l9_186=(*sc_set0.UserUniforms).Port_Import_N050;
float3 l9_187=float3(0.0);
l9_187=l9_106+l9_186;
gParticle.Position=l9_187;
float3 l9_188=float3(0.0);
l9_188=(*sc_set0.UserUniforms).Port_Import_N056;
float3 l9_189=float3(0.0);
l9_189=(*sc_set0.UserUniforms).Port_Import_N067;
...
l9_270=(*sc_set0.UserUniforms).Port_Import_N005;
float3 l9_271=float3(0.0);
l9_271=(*sc_set0.UserUniforms).Port_Import_N007;
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_361/20000]*float4(gParticle.Position,1.0)).xyz;
int l9_362=gl_InstanceIndex;
int l9_363=l9_362/20000;
...
gParticle.Size=fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_366/20000][0].xyz),fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_367/20000][1].xyz),length((*sc_set0.UserUniforms).vfxModelMatrix[l9_368/20000][2].xyz)))*gParticle.Size;
int l9_369=gl_InstanceIndex;
int l9_370=l9_369/20000;
...
float3 Value_N74=float3(0.0);
Value_N74=(*sc_set0.UserUniforms).Port_Import_N074;
float3 Output_N75=float3(0.0);
Output_N75=(Value_N73*Value_N74)*float3((*sc_set0.UserUniforms).Port_Input2_N075);
float3 Value_N76=float3(0.0);
Value_N76=(*sc_set0.UserUniforms).Port_Import_N076;
float Time_N77=0.0;
Time_N77=Globals.gTimeElapsedShifted*(*sc_set0.UserUniforms).Port_Multiplier_N077;
float3 Output_N78=float3(0.0);
Output_N78=Value_N76*float3(Time_N77);
float3 Output_N79=float3(0.0);
Output_N79=Output_N75+Output_N78;
float2 Output_N80=float2(0.0);
Output_N80=float2(Output_N79.x,Output_N79.y);
float2 Output_N81=float2(0.0);
Output_N81=Output_N80+(*sc_set0.UserUniforms).Port_Input1_N081;
float Noise_N82=0.0;
float2 param_3=Output_N81;
float2 param_4=(*sc_set0.UserUniforms).Port_Scale_N082;
...
Output_N83=float2(Output_N79.y,Output_N79.z);
float2 Output_N84=float2(0.0);
Output_N84=Output_N83+(*sc_set0.UserUniforms).Port_Input1_N084;
float Noise_N86=0.0;
float2 param_6=Output_N84;
float2 param_7=(*sc_set0.UserUniforms).Port_Scale_N086;
...
Output_N87=float2(Output_N79.z,Output_N79.x);
float2 Output_N88=float2(0.0);
Output_N88=Output_N87+(*sc_set0.UserUniforms).Port_Input1_N088;
float Noise_N89=0.0;
float2 param_9=Output_N88;
float2 param_10=(*sc_set0.UserUniforms).Port_Scale_N089;
...
Value_N90.x=Noise_N82;
Value_N90.y=Noise_N86;
Value_N90.z=Noise_N89;
float3 Output_N91=float3(0.0);
Output_N91=Value_N90*(*sc_set0.UserUniforms).Port_Input1_N091;
float3 Output_N92=float3(0.0);
Output_N92=Output_N91-float3(1.0);
float3 Output_N93=float3(0.0);
Output_N93=Value_N72*Output_N92;
gParticle.Force+=Output_N93;
float Value_N20=0.0;
Value_N20=(*sc_set0.UserUniforms).Port_Import_N020;
float Value_N21=0.0;
Value_N21=gParticle.Mass;
float Output_N136=0.0;
Output_N136=(Value_N20*Value_N21)*(*sc_set0.UserUniforms).Port_Input2_N136;
float3 Output_N57=float3(0.0);
Output_N57=float3(0.0,Output_N136,0.0);
...
Random_N12=param_18;
float Value_N62=0.0;
Value_N62=Random_N12;
float Value_N63=0.0;
Value_N63=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float Output_N64=0.0;
Output_N64=mix(Value_N60,Value_N62,Value_N63);
gParticle.Size=Output_N64;
float4 Value_N97=float4(0.0);
Value_N97=gParticle.Color;
float Value_N98=0.0;
Value_N98=(*sc_set0.UserUniforms).Port_Import_N098;
float Value_N99=0.0;
Value_N99=(*sc_set0.UserUniforms).Port_Import_N099;
float Value_N100=0.0;
Value_N100=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float Output_N101=0.0;
Output_N101=mix(Value_N98,Value_N99,Value_N100);
float4 Value_N102=float4(0.0);
Value_N102=float4(Value_N97.xyz.x,Value_N97.xyz.y,Value_N97.xyz.z,Value_N102.w);
Value_N102.w=Output_N101;
gParticle.Color=Value_N102;
float3x3 ValueMatrix_N107=float3x3(float3(0.0),float3(0.0),float3(0.0));
ValueMatrix_N107=gParticle.Matrix;
float Random_N115=0.0;
float param_20=(*sc_set0.UserUniforms).Port_Min_N115;
float param_21=(*sc_set0.UserUniforms).Port_Max_N115;
...
Random_N115=param_22;
float3 Output_N116=float3(0.0);
Output_N116=float3(0.0,0.0,Random_N115);
float3 Value_N108=float3(0.0);
Value_N108=Output_N116;
float3 Output_N109=float3(0.0);
float3 param_24=Value_N108;
...
Output_N109=param_25;
float Value_N110=0.0;
Value_N110=(*sc_set0.UserUniforms).Port_Import_N110;
float3x3 Matrix_N111=float3x3(float3(0.0),float3(0.0),float3(0.0));
float3 param_26=Output_N109;
float param_27=Value_N110;
...
Matrix_N111=param_28;
float3x3 Output_N112=float3x3(float3(0.0),float3(0.0),float3(0.0));
Output_N112=ValueMatrix_N107*Matrix_N111;
gParticle.Matrix=Output_N112;
