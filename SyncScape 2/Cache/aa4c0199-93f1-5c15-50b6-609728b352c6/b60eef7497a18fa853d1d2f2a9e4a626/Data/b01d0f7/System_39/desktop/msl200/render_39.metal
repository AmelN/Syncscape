...
//sampler sampler Tweak_N4SmpSC 0:22
...
//texture texture2D Tweak_N4 0:0:0:22
...
//float3x3 Tweak_N4Transform 7440
//float4 Tweak_N4UvMinMax 7488
//float4 Tweak_N4BorderColor 7504
//float2 Port_SpriteCount_N014 7528
//float Port_MaxFrames_N014 7536
//float Port_Min_N002 7540
//float Port_Max_N002 7544
//float Port_Input1_N023 7556
//float Port_Input1_N027 7560
//float Port_Input2_N027 7564
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N4 30 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 31 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N4 32 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 33 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N4 34 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 35 0
//spec_const bool Tweak_N4HasSwappedViews 36 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N4 52 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 53 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N4 54 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 55 -1
//spec_const int Tweak_N4Layout 56 0
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N4 [[function_constant(30)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N4 [[function_constant(32)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N4 [[function_constant(34)]];
...
constant bool Tweak_N4HasSwappedViews [[function_constant(36)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N4 [[function_constant(52)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N4 [[function_constant(54)]];
...
constant int Tweak_N4Layout [[function_constant(56)]];
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/10000]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_4=l9_3>=(10000*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/10000]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/10000];
...
float Random_N2=0.0;
float param_2=(*sc_set0.UserUniforms).Port_Min_N002;
float param_3=(*sc_set0.UserUniforms).Port_Max_N002;
...
bool l9_27=true;
float l9_28=2.0;
ssParticle l9_29=gParticle;
float l9_30=0.0;
float l9_31=param_5.gTimeElapsed;
float4 l9_32=float4(0.0);
float4 l9_33=float4(0.0);
if (l9_25)
{
l9_33.x=floor(fract(l9_31)*1000.0);
}
if (l9_27)
{
l9_33.y=float(l9_29.Index1D^((l9_29.Index1D*15299)+l9_29.Index1D));
}
if (l9_26)
{
l9_33.z=l9_28;
}
l9_33.w=l9_30*1000.0;
int l9_34=int(l9_33.x);
int l9_35=int(l9_33.y);
int l9_36=int(l9_33.z);
int l9_37=int(l9_33.w);
int l9_38=(((l9_34*15299)^(l9_35*30133))^(l9_36*17539))^(l9_37*12113);
int l9_39=l9_38;
if (l9_24==1)
{
int l9_40=l9_39;
int l9_41=l9_40;
int l9_42=((l9_41*((l9_41*1471343)+101146501))+1559861749)&2147483647;
int l9_43=l9_42;
float l9_44=float(l9_43)*4.6566129e-10;
float l9_45=l9_44;
l9_32.x=l9_45;
}
else
...
float2 l9_57=float2(l9_54,l9_56);
l9_32=float4(l9_57.x,l9_57.y,l9_32.z,l9_32.w);
}
else
{
if (l9_24==3)
...
float3 l9_74=float3(l9_69,l9_71,l9_73);
l9_32=float4(l9_74.x,l9_74.y,l9_74.z,l9_32.w);
}
else
{
int l9_75=l9_39;
...
float4 l9_96=float4(l9_89,l9_91,l9_93,l9_95);
l9_32=l9_96;
}
}
}
float4 l9_97=l9_32;
float4 l9_98=l9_97;
float param_4=mix(param_2,param_3,l9_98.x);
Random_N2=param_4;
float4 Color_N14=float4(0.0);
float2 param_6=(*sc_set0.UserUniforms).Port_SpriteCount_N014;
float param_7=(*sc_set0.UserUniforms).Port_MaxFrames_N014;
float param_8=Random_N2;
ssGlobals param_10=Globals;
float2 l9_99=float2(0.0);
float l9_100=floor(param_6.x);
float l9_101=floor(param_6.y);
float l9_102=1.0/l9_100;
float l9_103=1.0/l9_101;
float l9_104=fast::min(l9_100*l9_101,floor(param_7));
float l9_105=floor(mod(floor(param_8),l9_104));
float l9_106=floor(l9_105/l9_100);
float l9_107=mod(l9_105,l9_100);
l9_99=float2((l9_102*param_10.Surface_UVCoord0.x)+(l9_107*l9_102),((1.0-l9_103)-(l9_106*l9_103))+(l9_103*param_10.Surface_UVCoord0.y));
int l9_108;
...
int l9_113=l9_108;
int l9_114=Tweak_N4Layout_tmp;
int l9_115=l9_113;
float2 l9_116=l9_99;
bool l9_117=(int(SC_USE_UV_TRANSFORM_Tweak_N4_tmp)!=0);
float3x3 l9_118=(*sc_set0.UserUniforms).Tweak_N4Transform;
int2 l9_119=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N4_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N4_tmp);
bool l9_120=(int(SC_USE_UV_MIN_MAX_Tweak_N4_tmp)!=0);
float4 l9_121=(*sc_set0.UserUniforms).Tweak_N4UvMinMax;
bool l9_122=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N4_tmp)!=0);
float4 l9_123=(*sc_set0.UserUniforms).Tweak_N4BorderColor;
float l9_124=0.0;
...
float4 l9_191=sc_set0.Tweak_N4.sample(sc_set0.Tweak_N4SmpSC,l9_190.xy,bias(l9_184));
float4 l9_192=l9_191;
if (l9_122)
{
l9_192=mix(l9_123,l9_192,float4(l9_126));
}
float4 l9_193=l9_192;
float4 param_9=l9_193;
Color_N14=param_9;
float Output_N16=0.0;
Output_N16=Color_N14.w;
float Value_N22=0.0;
Value_N22=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float Output_N23=0.0;
Output_N23=Value_N22*(*sc_set0.UserUniforms).Port_Input1_N023;
float Output_N24=0.0;
Output_N24=Output_N16-Output_N23;
float4 Value_N8=float4(0.0);
Value_N8=gParticle.Color;
float Output_N29=0.0;
Output_N29=Value_N8.w;
float Output_N31=0.0;
Output_N31=Output_N24*Output_N29;
float Output_N27=0.0;
Output_N27=fast::clamp(Output_N31+0.001,(*sc_set0.UserUniforms).Port_Input1_N027+0.001,(*sc_set0.UserUniforms).Port_Input2_N027+0.001)-0.001;
float4 Value_N28=float4(0.0);
Value_N28=float4(Color_N14.xyz.x,Color_N14.xyz.y,Color_N14.xyz.z,Value_N28.w);
Value_N28.w=Output_N27;
float4 param_11=Value_N28;
...
{
float4 l9_197=out.sc_FragData0;
l9_196=l9_197;
}
else
{
float4 l9_198=gl_FragCoord;
float2 l9_199=l9_198.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_204=l9_203;
int l9_205=l9_204;
float3 l9_206=float3(l9_200,0.0);
int l9_207=l9_202;
int l9_208=l9_205;
if (l9_207==1)
{
l9_206.y=((2.0*l9_206.y)+float(l9_208))-1.0;
}
float2 l9_209=l9_206.xy;
l9_201=l9_209;
}
else
{
...
float4 l9_231=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_230.xy,bias(l9_224));
float4 l9_232=l9_231;
float4 l9_233=l9_232;
l9_196=l9_233;
}
float4 l9_234=l9_196;
float3 l9_235=l9_234.xyz;
float3 l9_236=l9_235;
float3 l9_237=l9_194.xyz;
...
l9_195=float4(l9_238.x,l9_238.y,l9_238.z,l9_195.w);
float3 l9_239=mix(l9_235,l9_195.xyz,float3(l9_194.w));
l9_195=float4(l9_239.x,l9_239.y,l9_239.z,l9_195.w);
l9_195.w=1.0;
float4 l9_240=l9_195;
param_12=l9_240;
}
else
{
...
{
float4 l9_241=float4(in.varScreenPos.xyz,1.0);
param_12=l9_241;
}
else
{
...
{
float4 l9_242=gl_FragCoord;
float l9_243=fast::clamp(abs(l9_242.z),0.0,1.0);
float4 l9_244=float4(l9_243,1.0-l9_243,1.0,1.0);
param_12=l9_244;
}
else
{
float4 l9_245=param_12;
float4 l9_246=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_246=float4(mix(float3(1.0),l9_245.xyz,float3(l9_245.w)),l9_245.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_247=l9_245.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_247=fast::clamp(l9_247,0.0,1.0);
}
l9_246=float4(l9_245.xyz*l9_247,l9_247);
}
else
{
l9_246=l9_245;
...
float4 l9_248=l9_246;
param_12=l9_248;
}
}
}
}
float4 l9_249=param_12;
Output_Color0=l9_249;
