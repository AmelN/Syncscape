...
//ubo int UserUniforms 0:35:7728 {
//float4 sc_Time 1376
...
//float Port_Import_N068 7392
//float Port_Import_N069 7396
//float3 Port_Import_N074 7408
//float3 Port_Import_N087 7424
//float3 Port_Import_N075 7440
//float3 Port_Import_N076 7456
//float3 Port_Import_N092 7472
//float3 Port_Import_N096 7488
//float3 Port_Import_N247 7504
//float3 Port_Import_N234 7520
//float Port_Input2_N235 7536
//float3 Port_Import_N062 7552
//float Port_Multiplier_N065 7568
//float2 Port_Input1_N237 7576
//float2 Port_Scale_N238 7584
//float2 Port_Input1_N240 7592
//float2 Port_Scale_N241 7600
//float2 Port_Input1_N243 7608
//float2 Port_Scale_N244 7616
//float3 Port_Input1_N066 7632
//float Port_Import_N033 7648
//float Port_Input2_N136 7652
//float Port_Min_N011 7656
//float Port_Max_N011 7660
//float Port_Min_N012 7668
//float Port_Max_N012 7672
//float Port_Import_N030 7680
//float Port_Import_N035 7684
//float Port_Min_N044 7688
//float Port_Max_N044 7692
//float Port_Import_N013 7712
//}
...
float3 Port_Import_N087;
float3 Port_Import_N075;
float3 Port_Import_N076;
float3 Port_Import_N092;
float3 Port_Import_N096;
float3 Port_Import_N247;
float3 Port_Import_N234;
float Port_Input2_N235;
float3 Port_Import_N062;
float Port_Multiplier_N065;
float2 Port_Input1_N237;
float2 Port_Scale_N238;
float2 Port_Input1_N240;
float2 Port_Scale_N241;
float2 Port_Input1_N243;
float2 Port_Scale_N244;
float3 Port_Input1_N066;
...
float Port_Min_N012;
float Port_Max_N012;
float Port_Import_N303;
float Port_Import_N030;
float Port_Import_N035;
float Port_Min_N044;
float Port_Max_N044;
float3 Port_Import_N098;
...
param.CopyId=float(param_1/10000);
...
l9_46=!(UserUniforms.vfxBatchEnable[l9_47/10000]!=0);
}
else
{
l9_46=l9_45;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/10000];
...
float l9_21=0.0;
l9_21=(*sc_set0.UserUniforms).Port_Import_N068;
float l9_22=0.0;
l9_22=(*sc_set0.UserUniforms).Port_Import_N069;
float l9_23=0.0;
float l9_24=l9_21;
float l9_25=l9_22;
...
l9_104=(*sc_set0.UserUniforms).Port_Import_N074;
...
l9_186=(*sc_set0.UserUniforms).Port_Import_N087;
float3 l9_187=float3(0.0);
l9_187=l9_106+l9_186;
gParticle.Position=l9_187;
float3 l9_188=float3(0.0);
l9_188=(*sc_set0.UserUniforms).Port_Import_N075;
float3 l9_189=float3(0.0);
l9_189=(*sc_set0.UserUniforms).Port_Import_N076;
float3 l9_190=float3(0.0);
float3 l9_191=l9_188;
float3 l9_192=l9_189;
ssGlobals l9_193=param_1;
int l9_194=3;
bool l9_195=true;
bool l9_196=true;
bool l9_197=true;
float l9_198=77.0;
ssParticle l9_199=gParticle;
float l9_200=0.0;
float l9_201=l9_193.gTimeElapsed;
float4 l9_202=float4(0.0);
float4 l9_203=float4(0.0);
if (l9_195)
{
l9_203.x=floor(fract(l9_201)*1000.0);
}
if (l9_197)
{
l9_203.y=float(l9_199.Index1D^((l9_199.Index1D*15299)+l9_199.Index1D));
}
if (l9_196)
{
l9_203.z=l9_198;
}
l9_203.w=l9_200*1000.0;
int l9_204=int(l9_203.x);
int l9_205=int(l9_203.y);
int l9_206=int(l9_203.z);
int l9_207=int(l9_203.w);
int l9_208=(((l9_204*15299)^(l9_205*30133))^(l9_206*17539))^(l9_207*12113);
int l9_209=l9_208;
if (l9_194==1)
{
int l9_210=l9_209;
int l9_211=l9_210;
int l9_212=((l9_211*((l9_211*1471343)+101146501))+1559861749)&2147483647;
int l9_213=l9_212;
float l9_214=float(l9_213)*4.6566129e-10;
float l9_215=l9_214;
l9_202.x=l9_215;
}
else
...
int l9_219=l9_218;
int l9_220=l9_216*1399;
int l9_221=((l9_220*((l9_220*1471343)+101146501))+1559861749)&2147483647;
int l9_222=l9_221;
int l9_223=l9_219;
float l9_224=float(l9_223)*4.6566129e-10;
int l9_225=l9_222;
float l9_226=float(l9_225)*4.6566129e-10;
float2 l9_227=float2(l9_224,l9_226);
l9_202=float4(l9_227.x,l9_227.y,l9_202.z,l9_202.w);
}
else
{
if (l9_194==3)
...
float3 l9_244=float3(l9_239,l9_241,l9_243);
l9_202=float4(l9_244.x,l9_244.y,l9_244.z,l9_202.w);
}
else
{
int l9_245=l9_209;
...
float4 l9_266=float4(l9_259,l9_261,l9_263,l9_265);
l9_202=l9_266;
}
}
}
float4 l9_267=l9_202;
float4 l9_268=l9_267;
float3 l9_269=mix(l9_191,l9_192,l9_268.xyz);
l9_190=l9_269;
gParticle.Velocity+=l9_190;
float3 l9_270=float3(0.0);
l9_270=(*sc_set0.UserUniforms).Port_Import_N092;
float3 l9_271=float3(0.0);
l9_271=(*sc_set0.UserUniforms).Port_Import_N096;
float3 l9_272=float3(0.0);
float3 l9_273=l9_270;
float3 l9_274=l9_271;
ssGlobals l9_275=param_1;
int l9_276=3;
bool l9_277=true;
bool l9_278=true;
bool l9_279=true;
float l9_280=97.0;
ssParticle l9_281=gParticle;
float l9_282=0.0;
float l9_283=l9_275.gTimeElapsed;
float4 l9_284=float4(0.0);
float4 l9_285=float4(0.0);
if (l9_277)
{
l9_285.x=floor(fract(l9_283)*1000.0);
}
if (l9_279)
{
l9_285.y=float(l9_281.Index1D^((l9_281.Index1D*15299)+l9_281.Index1D));
}
if (l9_278)
{
l9_285.z=l9_280;
}
l9_285.w=l9_282*1000.0;
int l9_286=int(l9_285.x);
int l9_287=int(l9_285.y);
int l9_288=int(l9_285.z);
int l9_289=int(l9_285.w);
int l9_290=(((l9_286*15299)^(l9_287*30133))^(l9_288*17539))^(l9_289*12113);
int l9_291=l9_290;
if (l9_276==1)
{
int l9_292=l9_291;
int l9_293=l9_292;
int l9_294=((l9_293*((l9_293*1471343)+101146501))+1559861749)&2147483647;
int l9_295=l9_294;
float l9_296=float(l9_295)*4.6566129e-10;
float l9_297=l9_296;
l9_284.x=l9_297;
}
else
...
float2 l9_309=float2(l9_306,l9_308);
l9_284=float4(l9_309.x,l9_309.y,l9_284.z,l9_284.w);
}
else
{
if (l9_276==3)
...
float3 l9_326=float3(l9_321,l9_323,l9_325);
l9_284=float4(l9_326.x,l9_326.y,l9_326.z,l9_284.w);
}
else
{
int l9_327=l9_291;
...
float4 l9_348=float4(l9_341,l9_343,l9_345,l9_347);
l9_284=l9_348;
}
}
}
float4 l9_349=l9_284;
float4 l9_350=l9_349;
float3 l9_351=mix(l9_273,l9_274,l9_350.xyz);
l9_272=l9_351;
float3x3 l9_352=float3x3(float3(0.0),float3(0.0),float3(0.0));
float3 l9_353=l9_272;
float l9_354=cos(radians(l9_353.x));
float l9_355=sin(radians(l9_353.x));
float l9_356=cos(radians(l9_353.y));
float l9_357=sin(radians(l9_353.y));
float l9_358=cos(radians(l9_353.z));
float l9_359=sin(radians(l9_353.z));
float3x3 l9_360=float3x3(float3(l9_356*l9_358,(l9_354*l9_359)+((l9_355*l9_357)*l9_358),(l9_355*l9_359)-((l9_354*l9_357)*l9_358)),float3((-l9_356)*l9_359,(l9_354*l9_358)-((l9_355*l9_357)*l9_359),(l9_355*l9_358)+((l9_354*l9_357)*l9_359)),float3(l9_357,(-l9_355)*l9_356,l9_354*l9_356));
l9_352=l9_360;
gParticle.Matrix=l9_352;
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_361/10000]*float4(gParticle.Position,1.0)).xyz;
int l9_362=gl_InstanceIndex;
int l9_363=l9_362/10000;
gParticle.Velocity=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_363][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_363][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_363][2].xyz)*gParticle.Velocity;
int l9_364=gl_InstanceIndex;
int l9_365=l9_364/10000;
gParticle.Force=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_365][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_365][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_365][2].xyz)*gParticle.Force;
int l9_366=gl_InstanceIndex;
int l9_367=gl_InstanceIndex;
int l9_368=gl_InstanceIndex;
gParticle.Size=fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_366/10000][0].xyz),fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_367/10000][1].xyz),length((*sc_set0.UserUniforms).vfxModelMatrix[l9_368/10000][2].xyz)))*gParticle.Size;
int l9_369=gl_InstanceIndex;
int l9_370=l9_369/10000;
gParticle.Matrix=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_370][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_370][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_370][2].xyz)*gParticle.Matrix;
...
float4 l9_374=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
out.gl_Position=l9_374;
return out;
}
float3 Value_N247=float3(0.0);
Value_N247=(*sc_set0.UserUniforms).Port_Import_N247;
float3 Value_N233=float3(0.0);
Value_N233=gParticle.Position;
float3 Value_N234=float3(0.0);
Value_N234=(*sc_set0.UserUniforms).Port_Import_N234;
float3 Output_N235=float3(0.0);
Output_N235=(Value_N233*Value_N234)*float3((*sc_set0.UserUniforms).Port_Input2_N235);
float3 Value_N62=float3(0.0);
Value_N62=(*sc_set0.UserUniforms).Port_Import_N062;
float Time_N65=0.0;
Time_N65=Globals.gTimeElapsedShifted*(*sc_set0.UserUniforms).Port_Multiplier_N065;
float3 Output_N64=float3(0.0);
Output_N64=Value_N62*float3(Time_N65);
float3 Output_N63=float3(0.0);
Output_N63=Output_N235+Output_N64;
float2 Output_N58=float2(0.0);
Output_N58=float2(Output_N63.x,Output_N63.y);
float2 Output_N237=float2(0.0);
Output_N237=Output_N58+(*sc_set0.UserUniforms).Port_Input1_N237;
float Noise_N238=0.0;
float2 param_3=Output_N237;
float2 param_4=(*sc_set0.UserUniforms).Port_Scale_N238;
param_3.x=floor(param_3.x*10000.0)*9.9999997e-05;
param_3.y=floor(param_3.y*10000.0)*9.9999997e-05;
param_3*=(param_4*0.5);
float2 l9_376=param_3;
float param_5=(snoise(l9_376)*0.5)+0.5;
param_5=floor(param_5*10000.0)*9.9999997e-05;
Noise_N238=param_5;
float2 Output_N59=float2(0.0);
Output_N59=float2(Output_N63.y,Output_N63.z);
float2 Output_N240=float2(0.0);
Output_N240=Output_N59+(*sc_set0.UserUniforms).Port_Input1_N240;
float Noise_N241=0.0;
float2 param_6=Output_N240;
float2 param_7=(*sc_set0.UserUniforms).Port_Scale_N241;
param_6.x=floor(param_6.x*10000.0)*9.9999997e-05;
param_6.y=floor(param_6.y*10000.0)*9.9999997e-05;
param_6*=(param_7*0.5);
float2 l9_377=param_6;
float param_8=(snoise(l9_377)*0.5)+0.5;
param_8=floor(param_8*10000.0)*9.9999997e-05;
Noise_N241=param_8;
float2 Output_N60=float2(0.0);
Output_N60=float2(Output_N63.z,Output_N63.x);
float2 Output_N243=float2(0.0);
Output_N243=Output_N60+(*sc_set0.UserUniforms).Port_Input1_N243;
float Noise_N244=0.0;
float2 param_9=Output_N243;
float2 param_10=(*sc_set0.UserUniforms).Port_Scale_N244;
param_9.x=floor(param_9.x*10000.0)*9.9999997e-05;
param_9.y=floor(param_9.y*10000.0)*9.9999997e-05;
param_9*=(param_10*0.5);
float2 l9_378=param_9;
float param_11=(snoise(l9_378)*0.5)+0.5;
param_11=floor(param_11*10000.0)*9.9999997e-05;
Noise_N244=param_11;
float3 Value_N246=float3(0.0);
Value_N246.x=Noise_N238;
Value_N246.y=Noise_N241;
Value_N246.z=Noise_N244;
float3 Output_N66=float3(0.0);
Output_N66=Value_N246*(*sc_set0.UserUniforms).Port_Input1_N066;
float3 Output_N21=float3(0.0);
Output_N21=Output_N66-float3(1.0);
float3 Output_N57=float3(0.0);
Output_N57=Value_N247*Output_N21;
gParticle.Force+=Output_N57;
float Value_N33=0.0;
Value_N33=(*sc_set0.UserUniforms).Port_Import_N033;
float Value_N34=0.0;
Value_N34=gParticle.Mass;
float Output_N136=0.0;
Output_N136=(Value_N33*Value_N34)*(*sc_set0.UserUniforms).Port_Input2_N136;
float3 Output_N36=float3(0.0);
Output_N36=float3(0.0,Output_N136,0.0);
gParticle.Force+=Output_N36;
float Random_N11=0.0;
float param_12=(*sc_set0.UserUniforms).Port_Min_N011;
float param_13=(*sc_set0.UserUniforms).Port_Max_N011;
...
bool l9_382=true;
float l9_383=11.0;
ssParticle l9_384=gParticle;
float l9_385=0.0;
float l9_386=param_15.gTimeElapsed;
float4 l9_387=float4(0.0);
float4 l9_388=float4(0.0);
if (l9_380)
{
l9_388.x=floor(fract(l9_386)*1000.0);
}
if (l9_382)
{
l9_388.y=float(l9_384.Index1D^((l9_384.Index1D*15299)+l9_384.Index1D));
}
if (l9_381)
{
l9_388.z=l9_383;
}
l9_388.w=l9_385*1000.0;
int l9_389=int(l9_388.x);
int l9_390=int(l9_388.y);
int l9_391=int(l9_388.z);
int l9_392=int(l9_388.w);
int l9_393=(((l9_389*15299)^(l9_390*30133))^(l9_391*17539))^(l9_392*12113);
int l9_394=l9_393;
if (l9_379==1)
{
int l9_395=l9_394;
...
int l9_398=l9_397;
float l9_399=float(l9_398)*4.6566129e-10;
float l9_400=l9_399;
l9_387.x=l9_400;
}
else
...
float2 l9_412=float2(l9_409,l9_411);
l9_387=float4(l9_412.x,l9_412.y,l9_387.z,l9_387.w);
}
else
{
if (l9_379==3)
...
int l9_422=l9_421;
int l9_423=l9_416;
float l9_424=float(l9_423)*4.6566129e-10;
int l9_425=l9_419;
float l9_426=float(l9_425)*4.6566129e-10;
int l9_427=l9_422;
float l9_428=float(l9_427)*4.6566129e-10;
float3 l9_429=float3(l9_424,l9_426,l9_428);
l9_387=float4(l9_429.x,l9_429.y,l9_429.z,l9_387.w);
}
else
{
int l9_430=l9_394;
...
float4 l9_451=float4(l9_444,l9_446,l9_448,l9_450);
l9_387=l9_451;
}
}
}
float4 l9_452=l9_387;
float4 l9_453=l9_452;
float param_14=mix(param_12,param_13,l9_453.x);
Random_N11=param_14;
float Value_N302=0.0;
Value_N302=Random_N11;
float Random_N12=0.0;
float param_16=(*sc_set0.UserUniforms).Port_Min_N012;
float param_17=(*sc_set0.UserUniforms).Port_Max_N012;
...
bool l9_457=true;
float l9_458=12.0;
ssParticle l9_459=gParticle;
float l9_460=0.0;
float l9_461=param_19.gTimeElapsed;
float4 l9_462=float4(0.0);
float4 l9_463=float4(0.0);
if (l9_455)
{
l9_463.x=floor(fract(l9_461)*1000.0);
}
if (l9_457)
{
l9_463.y=float(l9_459.Index1D^((l9_459.Index1D*15299)+l9_459.Index1D));
}
if (l9_456)
{
l9_463.z=l9_458;
}
l9_463.w=l9_460*1000.0;
int l9_464=int(l9_463.x);
int l9_465=int(l9_463.y);
int l9_466=int(l9_463.z);
int l9_467=int(l9_463.w);
int l9_468=(((l9_464*15299)^(l9_465*30133))^(l9_466*17539))^(l9_467*12113);
int l9_469=l9_468;
if (l9_454==1)
{
int l9_470=l9_469;
...
int l9_476=l9_469;
int l9_477=l9_476;
int l9_478=((l9_477*((l9_477*1471343)+101146501))+1559861749)&2147483647;
int l9_479=l9_478;
int l9_480=l9_476*1399;
...
float2 l9_487=float2(l9_484,l9_486);
l9_462=float4(l9_487.x,l9_487.y,l9_462.z,l9_462.w);
}
else
{
if (l9_454==3)
...
int l9_488=l9_469;
int l9_489=l9_488;
int l9_490=((l9_489*((l9_489*1471343)+101146501))+1559861749)&2147483647;
int l9_491=l9_490;
int l9_492=l9_488*1399;
int l9_493=((l9_492*((l9_492*1471343)+101146501))+1559861749)&2147483647;
int l9_494=l9_493;
int l9_495=l9_488*7177;
int l9_496=((l9_495*((l9_495*1471343)+101146501))+1559861749)&2147483647;
int l9_497=l9_496;
int l9_498=l9_491;
float l9_499=float(l9_498)*4.6566129e-10;
int l9_500=l9_494;
float l9_501=float(l9_500)*4.6566129e-10;
int l9_502=l9_497;
float l9_503=float(l9_502)*4.6566129e-10;
float3 l9_504=float3(l9_499,l9_501,l9_503);
l9_462=float4(l9_504.x,l9_504.y,l9_504.z,l9_462.w);
}
else
{
int l9_505=l9_469;
...
int l9_522=l9_514;
float l9_523=float(l9_522)*4.6566129e-10;
int l9_524=l9_517;
float l9_525=float(l9_524)*4.6566129e-10;
float4 l9_526=float4(l9_519,l9_521,l9_523,l9_525);
l9_462=l9_526;
}
}
}
float4 l9_527=l9_462;
float4 l9_528=l9_527;
float param_18=mix(param_16,param_17,l9_528.x);
Random_N12=param_18;
float Value_N303=0.0;
Value_N303=Random_N12;
float Value_N304=0.0;
Value_N304=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float Output_N305=0.0;
Output_N305=mix(Value_N302,Value_N303,Value_N304);
gParticle.Size=Output_N305;
float4 Value_N139=float4(0.0);
Value_N139=gParticle.Color;
float Value_N30=0.0;
Value_N30=(*sc_set0.UserUniforms).Port_Import_N030;
float Value_N35=0.0;
Value_N35=(*sc_set0.UserUniforms).Port_Import_N035;
float Value_N134=0.0;
Value_N134=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float Output_N135=0.0;
Output_N135=mix(Value_N30,Value_N35,Value_N134);
float4 Value_N176=float4(0.0);
Value_N176=float4(Value_N139.xyz.x,Value_N139.xyz.y,Value_N139.xyz.z,Value_N176.w);
Value_N176.w=Output_N135;
gParticle.Color=Value_N176;
float3x3 ValueMatrix_N71=float3x3(float3(0.0),float3(0.0),float3(0.0));
ValueMatrix_N71=gParticle.Matrix;
float Random_N44=0.0;
float param_20=(*sc_set0.UserUniforms).Port_Min_N044;
float param_21=(*sc_set0.UserUniforms).Port_Max_N044;
...
bool l9_532=true;
float l9_533=44.0;
ssParticle l9_534=gParticle;
float l9_535=0.0;
float l9_536=param_23.gTimeElapsed;
float4 l9_537=float4(0.0);
float4 l9_538=float4(0.0);
if (l9_530)
{
l9_538.x=floor(fract(l9_536)*1000.0);
}
if (l9_532)
{
l9_538.y=float(l9_534.Index1D^((l9_534.Index1D*15299)+l9_534.Index1D));
}
if (l9_531)
{
l9_538.z=l9_533;
}
l9_538.w=l9_535*1000.0;
int l9_539=int(l9_538.x);
int l9_540=int(l9_538.y);
int l9_541=int(l9_538.z);
int l9_542=int(l9_538.w);
int l9_543=(((l9_539*15299)^(l9_540*30133))^(l9_541*17539))^(l9_542*12113);
int l9_544=l9_543;
if (l9_529==1)
{
int l9_545=l9_544;
...
int l9_560=l9_557;
float l9_561=float(l9_560)*4.6566129e-10;
float2 l9_562=float2(l9_559,l9_561);
l9_537=float4(l9_562.x,l9_562.y,l9_537.z,l9_537.w);
}
else
{
if (l9_529==3)
...
int l9_566=l9_565;
int l9_567=l9_563*1399;
int l9_568=((l9_567*((l9_567*1471343)+101146501))+1559861749)&2147483647;
int l9_569=l9_568;
int l9_570=l9_563*7177;
int l9_571=((l9_570*((l9_570*1471343)+101146501))+1559861749)&2147483647;
int l9_572=l9_571;
int l9_573=l9_566;
float l9_574=float(l9_573)*4.6566129e-10;
int l9_575=l9_569;
float l9_576=float(l9_575)*4.6566129e-10;
int l9_577=l9_572;
float l9_578=float(l9_577)*4.6566129e-10;
float3 l9_579=float3(l9_574,l9_576,l9_578);
l9_537=float4(l9_579.x,l9_579.y,l9_579.z,l9_537.w);
}
else
{
int l9_580=l9_544;
...
int l9_583=l9_582;
int l9_584=l9_580*1399;
int l9_585=((l9_584*((l9_584*1471343)+101146501))+1559861749)&2147483647;
int l9_586=l9_585;
int l9_587=l9_580*7177;
int l9_588=((l9_587*((l9_587*1471343)+101146501))+1559861749)&2147483647;
int l9_589=l9_588;
int l9_590=l9_580*18919;
int l9_591=((l9_590*((l9_590*1471343)+101146501))+1559861749)&2147483647;
int l9_592=l9_591;
int l9_593=l9_583;
float l9_594=float(l9_593)*4.6566129e-10;
int l9_595=l9_586;
...
float4 l9_601=float4(l9_594,l9_596,l9_598,l9_600);
l9_537=l9_601;
}
}
}
float4 l9_602=l9_537;
float4 l9_603=l9_602;
float param_22=mix(param_20,param_21,l9_603.x);
Random_N44=param_22;
float3 Output_N45=float3(0.0);
Output_N45=float3(0.0,0.0,Random_N44);
float3 Value_N98=float3(0.0);
Value_N98=Output_N45;
float3 Output_N7=float3(0.0);
float3 param_24=Value_N98;
float l9_604=dot(param_24,param_24);
float l9_605;
if (l9_604>0.0)
{
l9_605=1.0/sqrt(l9_604);
}
else
{
l9_605=0.0;
...
float l9_606=l9_605;
float3 param_25=param_24*l9_606;
Output_N7=param_25;
float Value_N13=0.0;
Value_N13=(*sc_set0.UserUniforms).Port_Import_N013;
float3x3 Matrix_N41=float3x3(float3(0.0),float3(0.0),float3(0.0));
float3 param_26=Output_N7;
float param_27=Value_N13;
float3 l9_607=normalize(param_26);
float l9_608=sin(radians(param_27));
float l9_609=cos(radians(param_27));
float l9_610=1.0-l9_609;
float3x3 param_28=float3x3(float3(((l9_610*l9_607.x)*l9_607.x)+l9_609,((l9_610*l9_607.x)*l9_607.y)-(l9_607.z*l9_608),((l9_610*l9_607.z)*l9_607.x)+(l9_607.y*l9_608)),float3(((l9_610*l9_607.x)*l9_607.y)+(l9_607.z*l9_608),((l9_610*l9_607.y)*l9_607.y)+l9_609,((l9_610*l9_607.y)*l9_607.z)-(l9_607.x*l9_608)),float3(((l9_610*l9_607.z)*l9_607.x)-(l9_607.y*l9_608),((l9_610*l9_607.y)*l9_607.z)+(l9_607.x*l9_608),((l9_610*l9_607.z)*l9_607.z)+l9_609));
Matrix_N41=param_28;
float3x3 Output_N42=float3x3(float3(0.0),float3(0.0),float3(0.0));
Output_N42=ValueMatrix_N71*Matrix_N41;
gParticle.Matrix=Output_N42;
float3x3 param_29=gParticle.Matrix;
gParticle.Quaternion=matrixToQuaternion(param_29);
float Drift=0.0049999999;
if (gParticle.Dead)
{
float4 param_30=float4(4334.0,4334.0,4334.0,0.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_611=param_30;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_612=dot(l9_611,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_613=l9_612;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_613;
}
}
float4 l9_614=float4(param_30.x,-param_30.y,(param_30.z*0.5)+(param_30.w*0.5),param_30.w);
out.gl_Position=l9_614;
return out;
}
float l9_615;
...
{
l9_615=gParticle.Force.x;
}
gParticle.Force.x=l9_615;
float l9_616;
...
{
l9_616=gParticle.Force.y;
}
gParticle.Force.y=l9_616;
float l9_617;
...
{
l9_617=gParticle.Force.z;
}
gParticle.Force.z=l9_617;
...
{
l9_618=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_618;
float l9_619;
...
{
l9_619=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_619;
float l9_620;
...
{
l9_620=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_620;
...
Vertex.y=l9_622;
Vertex+=Offset;
float4 param_31=float4((Vertex*2.0)-float2(1.0),1.0,1.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_623=param_31;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_624=dot(l9_623,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_625=l9_624;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_625;
}
}
float4 l9_626=float4(param_31.x,-param_31.y,(param_31.z*0.5)+(param_31.w*0.5),param_31.w);
out.gl_Position=l9_626;
...
if (gParticle.Dead)
{
float4 param_32=float4(4334.0,4334.0,4334.0,0.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_630=float4(param_32.x,-param_32.y,(param_32.z*0.5)+(param_32.w*0.5),param_32.w);
