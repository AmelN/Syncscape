...
//float3 Port_Import_N074 7392
//float3 Port_Import_N087 7408
//float3 Port_Import_N075 7424
//float3 Port_Import_N076 7440
//float Port_Import_N068 7456
//float Port_Import_N069 7460
//float Port_Import_N011 7464
//float Port_Import_N012 7468
//float3 Port_Import_N247 7472
//float3 Port_Import_N234 7488
//float Port_Input2_N235 7504
//float3 Port_Import_N062 7520
//float Port_Multiplier_N065 7536
//float2 Port_Input1_N237 7544
//float2 Port_Scale_N238 7552
//float2 Port_Input1_N240 7560
//float2 Port_Scale_N241 7568
//float2 Port_Input1_N243 7576
//float2 Port_Scale_N244 7584
//float3 Port_Input1_N066 7600
//float Port_Import_N018 7616
//float Port_Input2_N020 7620
//float Port_Import_N027 7624
//float Port_Import_N028 7628
//}
...
param.CopyId=float(param_1/32000);
...
param_3.SpawnOffset=param_3.Ratio1D*16.0;
...
l9_19.Seed+=(floor(((((l9_22-l9_19.SpawnOffset)-0.0)+0.0)+32.0)/16.0)*4.32723);
...
l9_46=!(UserUniforms.vfxBatchEnable[l9_47/32000]!=0);
}
else
{
l9_46=l9_45;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/32000];
...
float Delay=0.0;
float Warmup=0.0;
gParticle.Age=mod((Globals.gTimeElapsedShifted-gParticle.SpawnOffset)+Warmup,16.0);
...
if (!l9_13)
{
l9_14=mod(((fast::max(Globals.gTimeElapsed,0.1)-gParticle.SpawnOffset)-Delay)+Warmup,16.0)<=Globals.gTimeDelta;
}
else
{
l9_14=l9_13;
...
l9_15.Seed+=(floor(((((l9_18-l9_15.SpawnOffset)-0.0)+0.0)+32.0)/16.0)*4.32723);
...
l9_21=(*sc_set0.UserUniforms).Port_Import_N074;
...
l9_103=(*sc_set0.UserUniforms).Port_Import_N087;
float3 l9_104=float3(0.0);
l9_104=l9_23+l9_103;
gParticle.Position=l9_104;
float3 l9_105=float3(0.0);
l9_105=(*sc_set0.UserUniforms).Port_Import_N075;
float3 l9_106=float3(0.0);
l9_106=(*sc_set0.UserUniforms).Port_Import_N076;
...
float l9_187=0.0;
l9_187=(*sc_set0.UserUniforms).Port_Import_N068;
float l9_188=0.0;
l9_188=(*sc_set0.UserUniforms).Port_Import_N069;
float l9_189=0.0;
float l9_190=l9_187;
float l9_191=l9_188;
...
l9_189=l9_268;
float l9_269=l9_189;
gParticle.Life=l9_269;
gParticle.Life=fast::clamp(gParticle.Life,0.1,16.0);
float l9_270=0.0;
l9_270=(*sc_set0.UserUniforms).Port_Import_N011;
float l9_271=0.0;
l9_271=(*sc_set0.UserUniforms).Port_Import_N012;
float l9_272=0.0;
float l9_273=l9_270;
float l9_274=l9_271;
...
float l9_351=mix(l9_273,l9_274,l9_350.x);
l9_272=l9_351;
gParticle.Size=l9_272;
gParticle.Velocity+=((gParticle.Force/float3(gParticle.Mass))*0.033330001);
gParticle.Force=float3(0.0);
int l9_352=gl_InstanceIndex;
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_352/32000]*float4(gParticle.Position,1.0)).xyz;
int l9_353=gl_InstanceIndex;
int l9_354=l9_353/32000;
gParticle.Velocity=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_354][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_354][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_354][2].xyz)*gParticle.Velocity;
int l9_355=gl_InstanceIndex;
int l9_356=l9_355/32000;
gParticle.Force=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_356][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_356][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_356][2].xyz)*gParticle.Force;
int l9_357=gl_InstanceIndex;
int l9_358=gl_InstanceIndex;
int l9_359=gl_InstanceIndex;
gParticle.Size=fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_357/32000][0].xyz),fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_358/32000][1].xyz),length((*sc_set0.UserUniforms).vfxModelMatrix[l9_359/32000][2].xyz)))*gParticle.Size;
int l9_360=gl_InstanceIndex;
int l9_361=l9_360/32000;
gParticle.Matrix=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_361][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_361][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_361][2].xyz)*gParticle.Matrix;
...
float4 l9_365=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
...
param_3*=(param_4*0.5);
float2 l9_367=param_3;
float param_5=(snoise(l9_367)*0.5)+0.5;
...
param_6*=(param_7*0.5);
float2 l9_368=param_6;
float param_8=(snoise(l9_368)*0.5)+0.5;
...
float2 l9_369=param_9;
float param_11=(snoise(l9_369)*0.5)+0.5;
...
Output_N6=Output_N66-float3(1.0);
float3 Output_N57=float3(0.0);
Output_N57=Value_N247*Output_N6;
gParticle.Force+=Output_N57;
float Value_N18=0.0;
Value_N18=(*sc_set0.UserUniforms).Port_Import_N018;
float Value_N19=0.0;
Value_N19=gParticle.Mass;
float Output_N20=0.0;
Output_N20=(Value_N18*Value_N19)*(*sc_set0.UserUniforms).Port_Input2_N020;
float3 Output_N21=float3(0.0);
Output_N21=float3(0.0,Output_N20,0.0);
gParticle.Force+=Output_N21;
float4 Value_N26=float4(0.0);
Value_N26=gParticle.Color;
float Value_N27=0.0;
Value_N27=(*sc_set0.UserUniforms).Port_Import_N027;
float Value_N28=0.0;
Value_N28=(*sc_set0.UserUniforms).Port_Import_N028;
float Value_N29=0.0;
Value_N29=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float Output_N32=0.0;
Output_N32=mix(Value_N27,Value_N28,Value_N29);
float4 Value_N176=float4(0.0);
Value_N176=float4(Value_N26.xyz.x,Value_N26.xyz.y,Value_N26.xyz.z,Value_N176.w);
Value_N176.w=Output_N32;
...
float4 l9_370=param_13;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_371=dot(l9_370,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_372=l9_371;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_372;
}
}
float4 l9_373=float4(param_13.x,-param_13.y,(param_13.z*0.5)+(param_13.w*0.5),param_13.w);
out.gl_Position=l9_373;
return out;
}
float l9_374;
...
{
l9_374=gParticle.Force.x;
}
gParticle.Force.x=l9_374;
float l9_375;
...
{
l9_375=gParticle.Force.y;
}
gParticle.Force.y=l9_375;
float l9_376;
...
{
l9_376=gParticle.Force.z;
}
gParticle.Force.z=l9_376;
...
{
l9_377=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_377;
float l9_378;
...
{
l9_378=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_378;
float l9_379;
...
{
l9_379=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_379;
...
float4 l9_382=param_14;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_383=dot(l9_382,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_384=l9_383;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_384;
}
}
float4 l9_385=float4(param_14.x,-param_14.y,(param_14.z*0.5)+(param_14.w*0.5),param_14.w);
out.gl_Position=l9_385;
...
float4 l9_386=param_15;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_387=dot(l9_386,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_388=l9_387;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_388;
}
}
float4 l9_389=float4(param_15.x,-param_15.y,(param_15.z*0.5)+(param_15.w*0.5),param_15.w);
out.gl_Position=l9_389;
return out;
}
return out;
}
