...
//float Port_Value_N172 7396
//float Port_Import_N163 7400
//float Port_Input1_N093 7404
//float3 Port_Input1_N181 7408
//float Port_Input1_N171 7424
//float2 Port_Input1_N137 7432
//float Port_Input1_N138 7440
//float Port_Import_N140 7444
//float Port_Import_N142 7448
//float Port_Input1_N144 7452
//float Port_Input2_N144 7456
//float Port_Value2_N041 7460
//}
...
float Port_Value_N172;
float Port_Import_N163;
float Port_Input1_N093;
float3 Port_Input1_N181;
...
float Port_Import_N142;
float Port_Input1_N144;
float Port_Input2_N144;
float Port_Value2_N041;
};
struct sc_Set0
{
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/32000]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_4=l9_3>=(32000*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/32000]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/32000];
...
Value_N161=gParticle.Position;
float Value_N162=0.0;
Value_N162=gParticle.Size;
float2 UVCoord_N184=float2(0.0);
UVCoord_N184=Globals.Surface_UVCoord0;
float2 Output_N185=float2(0.0);
Output_N185=UVCoord_N184-float2((*sc_set0.UserUniforms).Port_Input1_N185);
...
Value1_N186=param_6;
Value2_N186=param_7;
float3 Output_N181=float3(0.0);
float param_8=1.0;
float3 param_9=(*sc_set0.UserUniforms).Port_Input1_N181;
float3 param_10=float3(0.0);
float3 l9_36=float3(0.0);
l9_36=gParticle.Velocity;
float l9_37=0.0;
l9_37=length(l9_36);
float l9_38=0.0;
float l9_39=(*sc_set0.UserUniforms).Port_Value_N172;
float l9_40=l9_39+0.001;
l9_40-=0.001;
l9_38=l9_40;
float l9_41=0.0;
l9_41=float(l9_37<l9_38);
float l9_42=0.0;
l9_42=(*sc_set0.UserUniforms).Port_Import_N163;
float l9_43=0.0;
l9_43=float(l9_42<(*sc_set0.UserUniforms).Port_Input1_N093);
float l9_44=0.0;
float l9_45=l9_41;
...
Output_N181=param_11;
float3 Camera_Position_N33=float3(0.0);
Camera_Position_N33=(*sc_set0.UserUniforms).sc_Camera.position;
float3 Value_N34=float3(0.0);
Value_N34=gParticle.Position;
float3 Output_N35=float3(0.0);
Output_N35=Camera_Position_N33-Value_N34;
float3 Output_N36=float3(0.0);
float3 param_12=Output_N35;
...
Result_N188=cross(Output_N181,Output_N36);
...
Output_N190=(float3(Value_N162)*float3(Value1_N186))*Output_N189;
float3 Value_N164=float3(0.0);
Value_N164=gParticle.Velocity;
float Output_N165=0.0;
Output_N165=length(Value_N164);
float Value_N163=0.0;
Value_N163=(*sc_set0.UserUniforms).Port_Import_N163;
float Output_N168=0.0;
Output_N168=Output_N165*Value_N163;
float Output_N171=0.0;
Output_N171=fast::max(Output_N168,(*sc_set0.UserUniforms).Port_Input1_N171);
float3 Output_N187=float3(0.0);
Output_N187=((float3(Value_N162)*float3(Value2_N186))*float3(Output_N171))*Output_N181;
float3 Output_N191=float3(0.0);
Output_N191=(Value_N161+Output_N190)+Output_N187;
float3 param_16=Output_N191;
out.varPosAndMotion=float4(param_16.x,param_16.y,param_16.z,out.varPosAndMotion.w);
float3 param_17=Output_N181;
out.varTangent=float4(param_17.x,param_17.y,param_17.z,out.varTangent.w);
float3 Result_N194=float3(0.0);
Result_N194=cross(Output_N181,Output_N189);
float3 Output_N195=float3(0.0);
float3 param_18=Result_N194;
...
Output_N195=param_19;
float3 param_20=Output_N195;
...
param_1.SpawnOffset=param_1.Ratio1D*16.0;
...
Value_N140=(*sc_set0.UserUniforms).Port_Import_N140;
float Output_N141=0.0;
float l9_24;
if (Output_N139<=0.0)
{
l9_24=0.0;
...
{
l9_24=pow(Output_N139,Value_N140);
}
Output_N141=l9_24;
float Value_N142=0.0;
Value_N142=(*sc_set0.UserUniforms).Port_Import_N142;
float Output_N143=0.0;
Output_N143=Output_N141*Value_N142;
float Output_N144=0.0;
Output_N144=fast::clamp(Output_N143+0.001,(*sc_set0.UserUniforms).Port_Input1_N144+0.001,(*sc_set0.UserUniforms).Port_Input2_N144+0.001)-0.001;
float Export_N145=0.0;
Export_N145=Output_N144;
float4 Value_N37=float4(0.0);
Value_N37=gParticle.Color;
float Output_N38=0.0;
Output_N38=Value_N37.w;
float Output_N42=0.0;
Output_N42=Export_N145*Output_N38;
float4 Value_N41=float4(0.0);
float3 l9_25=float3(Output_N42);
Value_N41=float4(l9_25.x,l9_25.y,l9_25.z,Value_N41.w);
Value_N41.w=(*sc_set0.UserUniforms).Port_Value2_N041;
float4 param_2=Value_N41;
