...
//float Port_Import_N123 4528
//float Port_Input0_N177 4532
//float Port_Input0_N147 4544
//float Port_Import_N145 4548
//float Port_B_N148 4552
//float Port_A_N155 4556
//float Port_Input0_N154 4560
//float Port_Input0_N160 4564
//float Port_B_N161 4568
//float Port_A_N167 4572
//float Port_Input0_N166 4576
//float Port_Input1_N173 4580
//float Port_Import_N193 4584
//float Port_Input2_N174 4588
//float Port_Input1_N176 4592
//float Port_Input1_N179 4596
//float Port_Input2_N179 4600
//float Port_Value2_N005 4604
//float depthRef 4612
//}
...
Value_N5.w=(*sc_set0.UserUniforms).Port_Value2_N005;
float4 Output_N8=float4(0.0);
float4 param_76=Value_N13;
float4 param_77=Value_N5;
float4 l9_451=param_76;
float4 l9_452=param_77;
float3 l9_453=l9_451.xyz*l9_451.w;
l9_451=float4(l9_453.x,l9_453.y,l9_453.z,l9_451.w);
float4 param_75=l9_451+(l9_452*(1.0-l9_451.w));
Output_N8=param_75;
...
{
float4 l9_454=gl_FragCoord;
float2 l9_455=floor(mod(l9_454.xy,float2(4.0)));
float l9_456=(mod(dot(l9_455,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_78<l9_456)
{
discard_fragment();
}
...
float4 l9_457=fast::max(param_79,float4(0.0));
float4 param_80=l9_457;
if (sc_ShaderCacheConstant_tmp!=0)
{
