...
//ubo int UserUniforms 0:35:7424 {
//float4 sc_Time 1376
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/2001]!=0);
}
else
{
l9_46=l9_45;
...
float l9_508=param_72.x*param_72.x;
float l9_509=param_72.y*param_72.y;
float l9_510=param_72.z*param_72.z;
float l9_511=param_72.x*param_72.z;
float l9_512=param_72.x*param_72.y;
float l9_513=param_72.y*param_72.z;
float l9_514=param_72.w*param_72.x;
float l9_515=param_72.w*param_72.y;
float l9_516=param_72.w*param_72.z;
float3x3 l9_517=float3x3(float3(1.0-(2.0*(l9_509+l9_510)),2.0*(l9_512+l9_516),2.0*(l9_511-l9_515)),float3(2.0*(l9_512-l9_516),1.0-(2.0*(l9_508+l9_510)),2.0*(l9_513+l9_514)),float3(2.0*(l9_511+l9_515),2.0*(l9_513-l9_514),1.0-(2.0*(l9_508+l9_509))));
gParticle.Matrix=l9_517;
...
{
float l9_4=dot(l9_3,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_5=l9_4;
...
{
out.varClipDistance=l9_5;
}
}
float4 l9_6=float4(param.x,-param.y,(param.z*0.5)+(param.w*0.5),param.w);
out.gl_Position=l9_6;
return out;
}
int l9_8=ssInstanceID;
bool l9_9=l9_8>=(2001*((*sc_set0.UserUniforms).vfxNumCopies+1));
bool l9_10;
if (!l9_9)
{
l9_10=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/2001]!=0)==false;
}
else
{
l9_10=l9_9;
...
if (sc_StereoRenderingMode_tmp==1)
{
float l9_12=dot(l9_11,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_13=l9_12;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_13;
}
}
float4 l9_14=float4(param_1.x,-param_1.y,(param_1.z*0.5)+(param_1.w*0.5),param_1.w);
out.gl_Position=l9_14;
return out;
}
int param_2=ssInstanceID;
bool l9_15=ssDecodeParticle(param_2,ssInstanceID,gl_InstanceIndex,(*sc_set0.UserUniforms),sc_set0.renderTarget0,sc_set0.renderTarget0SmpSC,sc_set0.renderTarget1,sc_set0.renderTarget1SmpSC,sc_set0.renderTarget2,sc_set0.renderTarget2SmpSC,sc_set0.renderTarget3,sc_set0.renderTarget3SmpSC,gParticle);
if (!l9_15)
{
...
float l9_20=gParticle.Size;
bool l9_21=l9_20<9.9999997e-06;
bool l9_22;
if (!l9_21)
{
l9_22=gParticle.Age>=gParticle.Life;
}
else
{
l9_22=l9_21;
...
float4 l9_23=param_4;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_24=dot(l9_23,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_25=l9_24;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_25;
}
}
float4 l9_26=float4(param_4.x,-param_4.y,(param_4.z*0.5)+(param_4.w*0.5),param_4.w);
out.gl_Position=l9_26;
return out;
}
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[ssInstanceID/2001]*float4(gParticle.Position,1.0)).xyz;
int l9_27=ssInstanceID/2001;
gParticle.Velocity=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_27][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_27][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_27][2].xyz)*gParticle.Velocity;
int l9_28=ssInstanceID/2001;
...
int l9_29=ssInstanceID/2001;
gParticle.Matrix=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_29][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_29][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_29][2].xyz)*gParticle.Matrix;
float3 l9_30=gParticle.Position+((gParticle.Matrix*v.position.xyz)*gParticle.Size);
out.varPosAndMotion=float4(l9_30.x,l9_30.y,l9_30.z,out.varPosAndMotion.w);
float3 l9_31=gParticle.Matrix*v.normal;
out.varNormalAndMotion=float4(l9_31.x,l9_31.y,l9_31.z,out.varNormalAndMotion.w);
float3 l9_32=gParticle.Matrix*v.tangent;
...
{
l9_33=gl_InstanceIndex%2;
}
int l9_34=l9_33;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_34]*float4(out.varPosAndMotion.xyz,1.0);
...
int l9_36=l9_35;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_36][2].w!=0.0)
{
float l9_37=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
param_5.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_5.w))*l9_37)-1.0)*param_5.w;
}
}
...
float4 l9_39=param_6;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_40=dot(l9_39,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_41=l9_40;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
float4 l9_42=float4(param_6.x,-param_6.y,(param_6.z*0.5)+(param_6.w*0.5),param_6.w);
...
param_1.Index1DPerCopy=param%2001;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(2001*((param/2001)+1))-1;
...
float4 param_2=(*sc_set0.UserUniforms).Tweak_N24;
Output_N24=param_2;
float4 Value_N20=float4(0.0);
Value_N20=gParticle.Color;
float4 Output_N26=float4(0.0);
Output_N26=Output_N24*Value_N20;
float4 param_3=Output_N26;
Output_Color0=param_3;
...
float3 l9_59=l9_58;
float3 l9_60=l9_59;
float4 l9_61=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_60.xy,bias(l9_54));
float4 l9_62=l9_61;
float4 l9_63=l9_62;
l9_26=l9_63;
}
...
l9_25=float4(l9_68.x,l9_68.y,l9_68.z,l9_25.w);
float3 l9_69=mix(l9_65,l9_25.xyz,float3(l9_24.w));
l9_25=float4(l9_69.x,l9_69.y,l9_69.z,l9_25.w);
l9_25.w=1.0;
float4 l9_70=l9_25;
param_4=l9_70;
}
...
{
float4 l9_71=float4(in.varScreenPos.xyz,1.0);
param_4=l9_71;
}
else
{
...
float l9_73=fast::clamp(abs(l9_72.z),0.0,1.0);
float4 l9_74=float4(l9_73,1.0-l9_73,1.0,1.0);
param_4=l9_74;
}
else
{
float4 l9_75=param_4;
float4 l9_76=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_76=float4(mix(float3(1.0),l9_75.xyz,float3(l9_75.w)),l9_75.w);
}
else
{
...
l9_76=float4(l9_75.xyz*l9_77,l9_77);
}
else
{
l9_76=l9_75;
