...
//}
//ubo int UserUniforms 0:31:4608 {
//float4 sc_Time 1376
...
//float alpha 4544
//float4 Port_Default_N101 4560
//float3 Port_Normal_N089 4576
//float Port_Exponent_N089 4592
//float Port_Intensity_N089 4596
//float depthRef 4600
//}
...
float4 Tweak_N23;
float alpha;
float4 Port_Default_N101;
float3 Port_Normal_N089;
float Port_Exponent_N089;
float Port_Intensity_N089;
float depthRef;
};
struct sc_Bone_t
{
...
float4 param_11=(*sc_set0.UserUniforms).Port_Default_N101;
float l9_1=0.0;
...
Result_N101=param_12;
float Rim_N89=0.0;
float3 param_13=(*sc_set0.UserUniforms).Port_Normal_N089;
float param_14=(*sc_set0.UserUniforms).Port_Exponent_N089;
float param_15=(*sc_set0.UserUniforms).Port_Intensity_N089;
ssGlobals param_17=Globals;
param_13=float3x3(float3(param_17.VertexTangent_WorldSpace),float3(param_17.VertexBinormal_WorldSpace),float3(param_17.VertexNormal_WorldSpace))*param_13;
float l9_21=abs(dot(-param_17.ViewDirWS,param_13));
float param_16=pow(1.0-l9_21,param_14);
param_16=fast::max(param_16,0.0);
param_16*=param_15;
Rim_N89=param_16;
float4 Output_N90=float4(0.0);
Output_N90=Result_N101*float4(Rim_N89);
float Output_N0=0.0;
float param_18=(*sc_set0.UserUniforms).alpha;
Output_N0=param_18;
float4 Output_N1=float4(0.0);
Output_N1=Output_N90*float4(Output_N0);
...
float2 l9_23=floor(mod(l9_22.xy,float2(4.0)));
float l9_24=(mod(dot(l9_23,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_19<l9_24)
{
discard_fragment();
}
...
float4 l9_25=fast::max(param_20,float4(0.0));
float4 param_21=l9_25;
if (sc_ShaderCacheConstant_tmp!=0)
{
