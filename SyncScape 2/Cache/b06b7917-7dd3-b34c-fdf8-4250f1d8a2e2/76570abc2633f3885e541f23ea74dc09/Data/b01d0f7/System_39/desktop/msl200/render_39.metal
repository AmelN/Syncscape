...
//ubo int UserUniforms 0:37:7584 {
//float4 sc_Time 1376
...
//float2 Port_SizeMult_N009 7520
//float2 Port_PivotPoint_N009 7528
//float Port_VelocityStretchAmount_N009 7536
//float2 Port_SpriteCount_N019 7544
//float Port_MaxFrames_N019 7552
//float Port_Input1_N008 7556
//float Port_Input1_N002 7568
//float Port_Input2_N002 7572
//}
...
float2 Port_SizeMult_N009;
float2 Port_PivotPoint_N009;
float Port_VelocityStretchAmount_N009;
...
param.CopyId=float(param_1/120);
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/120]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_4=l9_3>=(120*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/120]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/120];
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[ssInstanceID/120]*float4(gParticle.Position,1.0)).xyz;
int l9_23=ssInstanceID/120;
...
float3 l9_25=gParticle.Position+(gParticle.Matrix*float3(v.position.x*gParticle.Size,v.position.y*gParticle.Size,0.0));
out.varPosAndMotion=float4(l9_25.x,l9_25.y,l9_25.z,out.varPosAndMotion.w);
float3 l9_26=gParticle.Matrix*float3(0.0,0.0,1.0);
out.varNormalAndMotion=float4(l9_26.x,l9_26.y,l9_26.z,out.varNormalAndMotion.w);
float3 l9_27=gParticle.Matrix*float3(1.0,0.0,0.0);
out.varTangent=float4(l9_27.x,l9_27.y,l9_27.z,out.varTangent.w);
out.varTangent.w=1.0;
out.varTex01=float4(v.texture0,v.texture1);
float2 param_4=(*sc_set0.UserUniforms).Port_SizeMult_N009;
float2 param_5=(*sc_set0.UserUniforms).Port_PivotPoint_N009;
float param_6=(*sc_set0.UserUniforms).Port_VelocityStretchAmount_N009;
...
int l9_29=l9_28;
float3 l9_30=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_29][1].xyz);
float l9_31=length(gParticle.Velocity);
float l9_32=fast::max(l9_31*param_6,1.0);
if ((l9_31>0.029999999)&&(param_6>9.9999997e-05))
{
l9_30=normalize(gParticle.Velocity);
}
int l9_33=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_34=l9_33;
float3 l9_35=-normalize(-(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_34][2].xyz);
float3 l9_36=normalize(cross(l9_35,l9_30));
float3 l9_37=normalize(cross(l9_36,l9_35));
float2 l9_38=(param_7.Surface_UVCoord0-float2(0.5))+param_5;
float2x2 l9_39=float2x2(float2(gParticle.Matrix[0].x,gParticle.Matrix[0].y),float2(gParticle.Matrix[1].x,gParticle.Matrix[1].y));
l9_38=l9_39*l9_38;
out.varPosAndMotion=float4(gParticle.Position.x,gParticle.Position.y,gParticle.Position.z,out.varPosAndMotion.w);
float3 l9_40=out.varPosAndMotion.xyz+((-l9_36)*((gParticle.Size*l9_38.x)*param_4.x));
out.varPosAndMotion=float4(l9_40.x,l9_40.y,l9_40.z,out.varPosAndMotion.w);
float3 l9_41=out.varPosAndMotion.xyz+(l9_37*(((gParticle.Size*l9_38.y)*param_4.y)*l9_32));
out.varPosAndMotion=float4(l9_41.x,l9_41.y,l9_41.z,out.varPosAndMotion.w);
out.varNormalAndMotion=float4(l9_35.x,l9_35.y,l9_35.z,out.varNormalAndMotion.w);
out.varTangent=float4(l9_37.x,l9_37.y,l9_37.z,out.varTangent.w);
int l9_42=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_42=0;
...
int l9_43=l9_42;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_43]*float4(out.varPosAndMotion.xyz,1.0);
...
param_8.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_8.w))*l9_46)-1.0)*param_8.w;
}
}
float4 l9_47=param_8;
clipPosition=l9_47;
...
float4 l9_51=float4(param_9.x,-param_9.y,(param_9.z*0.5)+(param_9.w*0.5),param_9.w);
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/120];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
param_1.Index1DPerCopy=param%120;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(120*((param/120)+1))-1;
