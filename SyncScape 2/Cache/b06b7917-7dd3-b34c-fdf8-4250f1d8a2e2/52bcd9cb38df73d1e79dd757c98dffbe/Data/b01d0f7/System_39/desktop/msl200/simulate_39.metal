...
l9_46=!(UserUniforms.vfxBatchEnable[l9_47/240]!=0);
}
else
{
l9_46=l9_45;
...
float Delay=0.0;
float Warmup=0.0;
gParticle.Age=mod((Globals.gTimeElapsedShifted-gParticle.SpawnOffset)+Warmup,0.40000001);
...
if (!l9_9)
{
l9_10=gParticle.Age>0.40000001;
}
else
{
l9_10=l9_9;
...
if (!l9_13)
{
l9_14=mod(((fast::max(Globals.gTimeElapsed,0.1)-gParticle.SpawnOffset)-Delay)+Warmup,0.40000001)<=Globals.gTimeDelta;
}
else
{
l9_14=l9_13;
...
l9_15.Seed+=(floor(((((l9_18-l9_15.SpawnOffset)-0.0)+0.0)+0.80000001)/0.40000001)*4.32723);
...
gParticle.Life=fast::clamp(gParticle.Life,0.1,0.40000001);
