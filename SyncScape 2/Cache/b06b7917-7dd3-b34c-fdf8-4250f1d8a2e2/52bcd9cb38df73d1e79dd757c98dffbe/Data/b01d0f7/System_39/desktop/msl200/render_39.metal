...
param.CopyId=float(param_1/240);
...
param_3.SpawnOffset=param_3.Ratio1D*0.40000001;
...
l9_19.Seed+=(floor(((((l9_22-l9_19.SpawnOffset)-0.0)+0.0)+0.80000001)/0.40000001)*4.32723);
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/240]!=0);
}
else
{
l9_46=l9_45;
...
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/240]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/240];
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[ssInstanceID/240]*float4(gParticle.Position,1.0)).xyz;
int l9_23=ssInstanceID/240;
...
param_1.SpawnOffset=param_1.Ratio1D*0.40000001;
