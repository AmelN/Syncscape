...
//texture texture2D materialParamsTex 0:5:0:27
//texture texture2D normalTex 0:6:0:28
...
//}
//ubo int UserUniforms 0:41:4976 {
...
//float4 Tweak_N8 4624
//float3x3 normalTexTransform 4688
//float4 normalTexUvMinMax 4736
//float4 normalTexBorderColor 4752
//float uvScale 4768
//float3x3 materialParamsTexTransform 4832
//float4 materialParamsTexUvMinMax 4880
//float4 materialParamsTexBorderColor 4896
//float2 Port_Center_N016 4912
//float3 Port_Emissive_N006 4928
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_materialParamsTex 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_normalTex 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_MIN_MAX_materialParamsTex 35 0
//spec_const bool SC_USE_UV_MIN_MAX_normalTex 36 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 37 0
//spec_const bool SC_USE_UV_TRANSFORM_materialParamsTex 38 0
//spec_const bool SC_USE_UV_TRANSFORM_normalTex 39 0
//spec_const bool UseViewSpaceDepthVariant 40 1
//spec_const bool intensityTextureHasSwappedViews 41 0
//spec_const bool materialParamsTexHasSwappedViews 42 0
//spec_const bool normalTexHasSwappedViews 43 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_materialParamsTex 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 90 -1
//spec_const int intensityTextureLayout 91 0
//spec_const int materialParamsTexLayout 92 0
//spec_const int normalTexLayout 93 0
...
constant bool SC_USE_CLAMP_TO_BORDER_materialParamsTex [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_materialParamsTex [[function_constant(35)]];
...
constant bool SC_USE_UV_MIN_MAX_normalTex [[function_constant(36)]];
...
constant bool SC_USE_UV_TRANSFORM_materialParamsTex [[function_constant(38)]];
...
constant bool SC_USE_UV_TRANSFORM_normalTex [[function_constant(39)]];
...
constant bool materialParamsTexHasSwappedViews [[function_constant(42)]];
...
constant bool normalTexHasSwappedViews [[function_constant(43)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_materialParamsTex [[function_constant(86)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_normalTex [[function_constant(87)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex [[function_constant(89)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_normalTex [[function_constant(90)]];
...
sampler materialParamsTexSmpSC [[id(27)]];
...
float4 param_1=(*sc_set0.UserUniforms).Tweak_N8;
Output_N8=param_1;
float Output_N5=0.0;
Output_N5=Output_N8.w;
float2 UVCoord_N11=float2(0.0);
UVCoord_N11=Globals.Surface_UVCoord0;
float Output_N0=0.0;
float param_2=(*sc_set0.UserUniforms).uvScale;
Output_N0=param_2;
...
int l9_6=l9_1;
int l9_7=normalTexLayout_tmp;
int l9_8=l9_6;
float2 l9_9=param_3;
bool l9_10=(int(SC_USE_UV_TRANSFORM_normalTex_tmp)!=0);
float3x3 l9_11=(*sc_set0.UserUniforms).normalTexTransform;
int2 l9_12=int2(SC_SOFTWARE_WRAP_MODE_U_normalTex_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTex_tmp);
bool l9_13=(int(SC_USE_UV_MIN_MAX_normalTex_tmp)!=0);
float4 l9_14=(*sc_set0.UserUniforms).normalTexUvMinMax;
bool l9_15=(int(SC_USE_CLAMP_TO_BORDER_normalTex_tmp)!=0);
float4 l9_16=(*sc_set0.UserUniforms).normalTexBorderColor;
float l9_17=0.0;
...
float3 l9_82=l9_81;
float3 l9_83=l9_82;
float4 l9_84=sc_set0.normalTex.sample(sc_set0.normalTexSmpSC,l9_83.xy,bias(l9_77));
float4 l9_85=l9_84;
if (l9_15)
{
...
float4 l9_86=l9_85;
float4 param_4=l9_86;
float3 l9_87=(param_4.xyz*1.9921875)-float3(1.0);
param_4=float4(l9_87.x,l9_87.y,l9_87.z,param_4.w);
Output_N9=param_4;
...
int l9_93=l9_88;
int param_5=materialParamsTexLayout_tmp;
int param_6=l9_93;
float2 param_7=CoordsOut_N16;
bool param_8=(int(SC_USE_UV_TRANSFORM_materialParamsTex_tmp)!=0);
float3x3 param_9=(*sc_set0.UserUniforms).materialParamsTexTransform;
int2 param_10=int2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex_tmp,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex_tmp);
bool param_11=(int(SC_USE_UV_MIN_MAX_materialParamsTex_tmp)!=0);
float4 param_12=(*sc_set0.UserUniforms).materialParamsTexUvMinMax;
bool param_13=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex_tmp)!=0);
float4 param_14=(*sc_set0.UserUniforms).materialParamsTexBorderColor;
float param_15=0.0;
bool l9_94=param_13&&(!param_11);
float l9_95=1.0;
float l9_96=param_7.x;
int l9_97=param_10.x;
if (l9_97==1)
{
l9_96=fract(l9_96);
}
...
if (l9_97==2)
{
float l9_98=fract(l9_96);
float l9_99=l9_96-l9_98;
float l9_100=step(0.25,fract(l9_99*0.5));
l9_96=mix(l9_98,1.0-l9_98,fast::clamp(l9_100,0.0,1.0));
}
}
param_7.x=l9_96;
float l9_101=param_7.y;
int l9_102=param_10.y;
if (l9_102==1)
{
l9_101=fract(l9_101);
}
...
float l9_108=param_7.x;
float l9_109=param_12.x;
float l9_110=param_12.z;
bool l9_111=l9_107;
float l9_112=l9_95;
...
float l9_117=param_7.y;
float l9_118=param_12.y;
float l9_119=param_12.w;
bool l9_120=l9_116;
float l9_121=l9_95;
...
float2 l9_124=param_7;
bool l9_125=param_8;
float3x3 l9_126=param_9;
if (l9_125)
{
l9_124=float2((l9_126*float3(l9_124,1.0)).xy);
}
float2 l9_127=l9_124;
param_7=l9_127;
float l9_128=param_7.x;
int l9_129=param_10.x;
bool l9_130=l9_94;
float l9_131=l9_95;
...
param_7.x=l9_128;
l9_95=l9_131;
float l9_139=param_7.y;
int l9_140=param_10.y;
bool l9_141=l9_94;
float l9_142=l9_95;
...
param_7.y=l9_139;
l9_95=l9_142;
float2 l9_150=param_7;
int l9_151=param_5;
int l9_152=param_6;
float l9_153=param_15;
...
float3 l9_159=l9_158;
float4 l9_160=sc_set0.materialParamsTex.sample(sc_set0.materialParamsTexSmpSC,l9_159.xy,bias(l9_153));
float4 l9_161=l9_160;
if (param_13)
{
l9_161=mix(param_14,l9_161,float4(l9_95));
}
...
float Value2_N3=0.0;
float Value3_N3=0.0;
float4 param_16=Output_N2;
float param_17=param_16.x;
float param_18=param_16.y;
float param_19=param_16.z;
Value1_N3=param_17;
Value2_N3=param_18;
Value3_N3=param_19;
float4 Output_N6=float4(0.0);
float3 param_20=Output_N8.xyz;
float param_21=Output_N5;
float3 param_22=Output_N9.xyz;
float3 param_23=(*sc_set0.UserUniforms).Port_Emissive_N006;
float param_24=Value1_N3;
float param_25=Value2_N3;
float3 param_26=float3(Value3_N3);
float3 param_27=(*sc_set0.UserUniforms).Port_SpecularAO_N006;
ssGlobals param_29=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_29.BumpedNormal=float3x3(float3(param_29.VertexTangent_WorldSpace),float3(param_29.VertexBinormal_WorldSpace),float3(param_29.VertexNormal_WorldSpace))*param_22;
}
param_21=fast::clamp(param_21,0.0,1.0);
float l9_163=param_21;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_163<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
Globals.Surface_UVCoord0=in.varTex01.xy;
float4 Output_N8=float4(0.0);
float4 param=(*sc_set0.UserUniforms).Tweak_N8;
Output_N8=param;
float Output_N5=0.0;
Output_N5=Output_N8.w;
float2 UVCoord_N11=float2(0.0);
...
int l9_5=l9_0;
int l9_6=normalTexLayout_tmp;
int l9_7=l9_5;
float2 l9_8=param_2;
bool l9_9=(int(SC_USE_UV_TRANSFORM_normalTex_tmp)!=0);
float3x3 l9_10=(*sc_set0.UserUniforms).normalTexTransform;
int2 l9_11=int2(SC_SOFTWARE_WRAP_MODE_U_normalTex_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTex_tmp);
bool l9_12=(int(SC_USE_UV_MIN_MAX_normalTex_tmp)!=0);
float4 l9_13=(*sc_set0.UserUniforms).normalTexUvMinMax;
bool l9_14=(int(SC_USE_CLAMP_TO_BORDER_normalTex_tmp)!=0);
float4 l9_15=(*sc_set0.UserUniforms).normalTexBorderColor;
float l9_16=0.0;
bool l9_17=l9_14&&(!l9_12);
float l9_18=1.0;
float l9_19=l9_8.x;
int l9_20=l9_11.x;
if (l9_20==1)
...
float3 l9_81=l9_80;
float3 l9_82=l9_81;
float4 l9_83=sc_set0.normalTex.sample(sc_set0.normalTexSmpSC,l9_82.xy,bias(l9_76));
float4 l9_84=l9_83;
if (l9_14)
{
l9_84=mix(l9_15,l9_84,float4(l9_18));
}
float4 l9_85=l9_84;
float4 param_3=l9_85;
float3 l9_86=(param_3.xyz*1.9921875)-float3(1.0);
param_3=float4(l9_86.x,l9_86.y,l9_86.z,param_3.w);
Output_N9=param_3;
float4 Output_N2=float4(0.0);
int l9_87;
if ((int(materialParamsTexHasSwappedViews_tmp)!=0))
...
int l9_92=l9_87;
int param_4=materialParamsTexLayout_tmp;
int param_5=l9_92;
float2 param_6=CoordsOut_N16;
bool param_7=(int(SC_USE_UV_TRANSFORM_materialParamsTex_tmp)!=0);
float3x3 param_8=(*sc_set0.UserUniforms).materialParamsTexTransform;
int2 param_9=int2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex_tmp,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex_tmp);
bool param_10=(int(SC_USE_UV_MIN_MAX_materialParamsTex_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).materialParamsTexUvMinMax;
bool param_12=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex_tmp)!=0);
float4 param_13=(*sc_set0.UserUniforms).materialParamsTexBorderColor;
float param_14=0.0;
bool l9_93=param_12&&(!param_10);
float l9_94=1.0;
float l9_95=param_6.x;
int l9_96=param_9.x;
if (l9_96==1)
{
l9_95=fract(l9_95);
...
param_6.x=l9_95;
float l9_100=param_6.y;
int l9_101=param_9.y;
if (l9_101==1)
{
l9_100=fract(l9_100);
}
...
float l9_107=param_6.x;
float l9_108=param_11.x;
float l9_109=param_11.z;
bool l9_110=l9_106;
float l9_111=l9_94;
...
float l9_116=param_6.y;
float l9_117=param_11.y;
float l9_118=param_11.w;
bool l9_119=l9_115;
float l9_120=l9_94;
...
float2 l9_123=param_6;
bool l9_124=param_7;
float3x3 l9_125=param_8;
if (l9_124)
{
...
param_6=l9_126;
float l9_127=param_6.x;
int l9_128=param_9.x;
bool l9_129=l9_93;
float l9_130=l9_94;
...
param_6.x=l9_127;
l9_94=l9_130;
float l9_138=param_6.y;
int l9_139=param_9.y;
bool l9_140=l9_93;
float l9_141=l9_94;
...
param_6.y=l9_138;
l9_94=l9_141;
float2 l9_149=param_6;
int l9_150=param_4;
int l9_151=param_5;
float l9_152=param_14;
...
float3 l9_158=l9_157;
float4 l9_159=sc_set0.materialParamsTex.sample(sc_set0.materialParamsTexSmpSC,l9_158.xy,bias(l9_152));
float4 l9_160=l9_159;
if (param_12)
{
l9_160=mix(param_13,l9_160,float4(l9_94));
}
float4 l9_161=l9_160;
Output_N2=l9_161;
float Value2_N3=0.0;
float4 param_15=Output_N2;
float param_16=param_15.y;
Value2_N3=param_16;
float param_17=Output_N5;
float3 param_18=Output_N9.xyz;
float param_19=Value2_N3;
ssGlobals param_20=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_20.BumpedNormal=float3x3(float3(param_20.VertexTangent_WorldSpace),float3(param_20.VertexBinormal_WorldSpace),float3(param_20.VertexNormal_WorldSpace))*param_18;
}
...
float3 l9_166=param_20.PositionWS;
float3 l9_167=param_20.BumpedNormal;
float l9_168=param_19;
float3 l9_169=l9_166;
float3 l9_170=l9_167;
float l9_171=l9_168;
uint l9_172=0u;
uint3 l9_173=uint3(round((l9_169-(*sc_set0.UserUniforms).sc_RayTracingOriginOffset)*(*sc_set0.UserUniforms).sc_RayTracingOriginScale));
out.sc_RayTracingPositionAndMask=uint4(l9_173.x,l9_173.y,l9_173.z,out.sc_RayTracingPositionAndMask.w);
out.sc_RayTracingPositionAndMask.w=(*sc_set0.UserUniforms).sc_RayTracingReceiverMask;
float3 l9_174=l9_170;
float l9_175=dot(abs(l9_174),float3(1.0));
l9_174/=float3(l9_175);
float2 l9_176=float2(fast::clamp(-l9_174.z,0.0,1.0));
float2 l9_177=l9_174.xy+mix(-l9_176,l9_176,step(float2(0.0),l9_174.xy));
uint l9_178=as_type<uint>(half2(l9_177));
uint2 l9_179=uint2(l9_178&65535u,l9_178>>16u);
out.sc_RayTracingNormalAndMore=uint4(l9_179.x,l9_179.y,out.sc_RayTracingNormalAndMore.z,out.sc_RayTracingNormalAndMore.w);
out.sc_RayTracingNormalAndMore.z=l9_172;
uint l9_180=uint(fast::clamp(l9_171,0.0,1.0)*1000.0);
l9_180 |= (((*sc_set0.UserUniforms).sc_RayTracingReceiverId%32u)<<10u);
out.sc_RayTracingNormalAndMore.w=l9_180;
return out;
}
