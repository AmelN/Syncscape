...
//}
//ubo int UserUniforms 0:43:5104 {
...
//float3x3 materialParamsTexTransform 4960
//float4 materialParamsTexUvMinMax 5008
//float4 materialParamsTexBorderColor 5024
//float2 Port_Center_N016 5040
//float3 Port_Emissive_N006 5056
//float3 Port_SpecularAO_N006 5072
//float depthRef 5088
//}
...
float4 l9_161=l9_160;
float4 param_15=l9_161;
float3 l9_162=(param_15.xyz*1.9921875)-float3(1.0);
param_15=float4(l9_162.x,l9_162.y,l9_162.z,param_15.w);
Output_N9=param_15;
...
int l9_168=l9_163;
int param_16=materialParamsTexLayout_tmp;
int param_17=l9_168;
float2 param_18=CoordsOut_N16;
bool param_19=(int(SC_USE_UV_TRANSFORM_materialParamsTex_tmp)!=0);
float3x3 param_20=(*sc_set0.UserUniforms).materialParamsTexTransform;
int2 param_21=int2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex_tmp,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex_tmp);
bool param_22=(int(SC_USE_UV_MIN_MAX_materialParamsTex_tmp)!=0);
float4 param_23=(*sc_set0.UserUniforms).materialParamsTexUvMinMax;
bool param_24=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex_tmp)!=0);
float4 param_25=(*sc_set0.UserUniforms).materialParamsTexBorderColor;
float param_26=0.0;
bool l9_169=param_24&&(!param_22);
float l9_170=1.0;
float l9_171=param_18.x;
int l9_172=param_21.x;
if (l9_172==1)
{
l9_171=fract(l9_171);
}
...
param_18.x=l9_171;
float l9_176=param_18.y;
int l9_177=param_21.y;
if (l9_177==1)
{
l9_176=fract(l9_176);
}
...
float l9_183=param_18.x;
float l9_184=param_23.x;
float l9_185=param_23.z;
bool l9_186=l9_182;
float l9_187=l9_170;
...
float l9_192=param_18.y;
float l9_193=param_23.y;
float l9_194=param_23.w;
bool l9_195=l9_191;
float l9_196=l9_170;
...
float2 l9_199=param_18;
bool l9_200=param_19;
float3x3 l9_201=param_20;
if (l9_200)
{
...
param_18=l9_202;
float l9_203=param_18.x;
int l9_204=param_21.x;
bool l9_205=l9_169;
float l9_206=l9_170;
...
param_18.x=l9_203;
l9_170=l9_206;
float l9_214=param_18.y;
int l9_215=param_21.y;
bool l9_216=l9_169;
float l9_217=l9_170;
...
param_18.y=l9_214;
l9_170=l9_217;
float2 l9_225=param_18;
int l9_226=param_16;
int l9_227=param_17;
float l9_228=param_26;
...
if (param_24)
{
l9_236=mix(param_25,l9_236,float4(l9_170));
}
...
float Value2_N3=0.0;
float Value3_N3=0.0;
float4 param_27=Output_N2;
float param_28=param_27.x;
float param_29=param_27.y;
float param_30=param_27.z;
Value1_N3=param_28;
Value2_N3=param_29;
Value3_N3=param_30;
float4 Output_N6=float4(0.0);
float3 param_31=Output_N8.xyz;
float param_32=Output_N5;
float3 param_33=Output_N9.xyz;
float3 param_34=(*sc_set0.UserUniforms).Port_Emissive_N006;
float param_35=Value1_N3;
float param_36=Value2_N3;
float3 param_37=float3(Value3_N3);
float3 param_38=(*sc_set0.UserUniforms).Port_SpecularAO_N006;
ssGlobals param_40=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_40.BumpedNormal=float3x3(float3(param_40.VertexTangent_WorldSpace),float3(param_40.VertexBinormal_WorldSpace),float3(param_40.VertexNormal_WorldSpace))*param_33;
}
param_32=fast::clamp(param_32,0.0,1.0);
float l9_238=param_32;
...
float4 l9_252=fast::max(param_41,float4(0.0));
float4 param_42=l9_252;
if (sc_ShaderCacheConstant_tmp!=0)
{
