...
script.setSlider2 = (inValue) => {
    let col1 = script.myRmv.mainMaterial.mainPass.baseColor;
    script.myRmv.mainMaterial.mainPass.baseColor = new vec4(col1.x, inValue/2, col1.z, 1);
...
script.setSlider3 = (inValue) => {
    let col1 = script.myRmv.mainMaterial.mainPass.baseColor;
    script.myRmv.mainMaterial.mainPass.baseColor = new vec4(col1.x, col1.y, inValue/2, 1);
