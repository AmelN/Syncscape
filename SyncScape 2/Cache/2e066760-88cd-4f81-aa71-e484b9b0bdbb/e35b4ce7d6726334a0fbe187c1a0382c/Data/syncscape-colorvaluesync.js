...
function onStart() {
  ...
  myStoragePropertySetA = new StoragePropertySet([myPropRmv]);
  syncEntityA = new SyncEntity(script, myStoragePropertySet, true);

  myPropRmvB = StorageProperty.forMeshVisualBaseColor(script.myRmvB, true);
  myStoragePropertySetB = new StoragePropertySet([myPropRmv]);
  syncEntity = new SyncEntity(script, myStoragePropertySet, true);

  myPropRmvB = StorageProperty.forMeshVisualBaseColor(script.myRmvC, true);
